...
class EP:
    ...
    def update(self, sample_batch):
        self.sample_batch = np.append(self.sample_batch, np.array(deepcopy(
            [sample for sample in sample_batch if sample.objs is not None])))
        for sample in sample_batch:
            if sample.objs is None: continue
        ...
        # TODO: WE MUST SCALE THE OBJECTIVES TO BE POSITIVE
